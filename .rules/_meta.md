...
- **Знання:** M (соло, прототип, UE5 C++ стек)
- **Інструменти:** 1 (Google Antigravity)
- **Розширення:** 1 (мультиагентний сетап: Architect, Gameplay, UI)
...
| `generation/output.md` | Rules for response formatting and diff presentation |
| `generation/patterns.md` | Explicit UE5 C++ patterns mapped from project code |
| `quality/eval.md` | Checklist before every code response |
